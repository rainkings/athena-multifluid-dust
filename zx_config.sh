#!/bin/bash
# python3 configure.py --prob=disk_snowline_2D_RT_erg_2_twopop --ndustfluid=7 --flux=hllc -hdf5 -omp --hdf5_path=${hdf5_path} -h5double --nghost=2 --coord=spherical_polar --eos=general/eos_phase_change --np=2 --nz=2 --cxx=g++
# 1p 1z run
