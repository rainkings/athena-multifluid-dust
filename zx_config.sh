#!/bin/bash
# python3 configure.py --prob=disk_snowline_2D_RT_erg_2_twopop --ndustfluid=5 --flux=hllc -hdf5 --hdf5_path=${hdf5_path} -h5double --nghost=2 --coord=spherical_polar --eos=general/eos_phase_change --np=2 --nz=2 --cxx=g++
# single core run
...
python3 configure.py --prob=disk_snowline_1d_2p --ndustfluid=3 --flux=hllc -hdf5 --hdf5_path=${hdf5_path} -h5double --nghost=2 --coord=cylindrical --eos=general/eos_phase_change --np=2 --nz=1 --cxx=g++
